...
function Homepage(props){
    ...
    return(
        ...
        <button className="homepage-btn"><NavLink to={'/findhouse'}>Search for House</NavLink></button>
        </div>
        </div>

        {/* about div starts here */}

        <div className="about-container" ref={props.contentRef}>
            <div className="about-inner-container-one">
                ...
                <button className="btn" onClick={()=>moreabout.current.scrollIntoView({ behavior: "smooth" })}>
        ...
        <div className="more-about-container" ref={moreabout}>
